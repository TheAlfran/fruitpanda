...
export default function LoginPage() {
  ...
  const submitLogin = async () => {
    ...
    try {
      ...
      const response = await axios.post("http://192.168.1.11:1337/api/auth/local", {
    ...
    <ParentContainer1>
      ...
      <LoginContainer>
        <LoginBox>
          ...
          <InputContainer>
            <Username placeholder='username' value={username} onChangeText={(text) => setUsername(text)}></Username>
            <PasswordContainer>
