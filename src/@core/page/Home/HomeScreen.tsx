...
import { FooterButton, FooterContainer, FooterContainer2, FooterText, FooterTextButton, ParentContainer, SlideImage, SlideText, StartButton, StartButtonContainer, StartButtonText, SwiperContainer, Title, TitleContainer } from "./homestyle"
